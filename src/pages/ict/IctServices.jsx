...
const IctServices = () => {
  return (
    <>
      <section>
        <NavBar />
        <div className="ictbg flex gap-y-5 flex-col justify-center items-center py-40 md:py-52 lg:py-60 bg-no-repeat bg-cover bg-blend-multiply bg-gray-800 bg-center">
              ...
              <div className="w-full mb-10 lg:mb-0 ">
                <div className="">
                  <p className="siliguri text-left text-lg leading-8 font-normal tracking-wide py-3">
                    At SolarClass ltd, we provide a wide variety of ICT services
                    to satisfy the very needs and requirements of our customers
                  </p>
