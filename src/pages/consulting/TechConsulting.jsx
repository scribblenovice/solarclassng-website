...
const TechConsulting = () => {
  return (
    <>
      <section>
        <NavBar />
        <div className="techbg flex gap-y-5 flex-col justify-center items-center h-screen bg-no-repeat bg-cover bg-blend-multiply bg-gray-800 bg-center">
                ...
                <div className="">
                  <Fade>
                    <p className="siliguri text-left text-lg leading-8 font-normal tracking-wide py-3">
                      ...
                      evolving technology areas to better equip them for service
                      delivery. We do this by leveraging on in-house expertise,
                      as well as in association with established local and
